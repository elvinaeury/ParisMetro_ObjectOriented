...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 17 10:37:47 2020
...
fichier_conf = '/Users/elvinagovendasamy/Projet_Metro/fichier_conf.txt'
...
class Closest_Stations(Shortest_Route):
    ...
    def temps_total2(self,source_x,source_y,target_x,target_y,temps_source,temps_target): #recuperer la liste des stations qui passent:
        ...
        for i in range (2,len(stations_visitees)-2):
           ...
           # direction = [self.ordre_station['Station']== station].[self.ordre_station['Station suivante']== station_apres].['Destination_1']
...
if __name__=='__main__':
    ...
    try:
      ...
      #  graph = dessin.combining_graphs(lat1,lon1,lat2,lon2,temps_source,temps_target)
        ...
        print("Désolée, il n'y a pas de station de métro à proximité, veuillez entrer d'autres coordonnées ou augmenter votre temps de marche")
